            ...
            return (
                <div>
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="btn-grout float-right">
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-md-4 col-sm-6">
                                    <h3 className="pull-right">Balance: <span className={parseFloat(client.balance) > 0 ? 'text-success' : 'text-danger'}>${parseFloat(client.balance).toFixed(2)}</span>
                                    {' '}
                                    <small>
